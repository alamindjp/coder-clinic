...
const JavascriptCourseInput = () => {
    return (
        <div className='p-5'>
            <p className='text-2xl font-bold text-green-500 text-center'>Js Course-Subsection Input Field</p>
            <form action="">
                ...
                <textarea className="textarea textarea-primary w-2/3" ></textarea>
...
export default JavascriptCourseInput;