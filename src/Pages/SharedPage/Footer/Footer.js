...
const Footer = () => {
  ...
  return (
    <div>
      <footer class="footer p-10 bg-base-100 text-black">
        <div>
          <span class="footer-title">Services</span>
          <a class="link link-hover">Free Courses</a>
          <a class="link link-hover">Quiz</a>
          <a class="link link-hover">Paid Courses</a>
          <a class="link link-hover">Interview Preparation</a>
        </div>
        <div>
          <span class="footer-title">Company</span>
          <a class="link link-hover">About us</a>
          <a class="link link-hover">Developers</a>
          <a class="link link-hover">Organization</a>
